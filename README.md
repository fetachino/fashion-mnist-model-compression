...
![Test accuracy comparison across pruning and quantization methods](docs/images/model-comparison.png)

The comparison is rendered from `experiment_summary.csv`; it makes the accuracy tradeoff across all six experiment configurations easier to scan.
